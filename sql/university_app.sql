CREATE SCHEMA `university_app` DEFAULT CHARACTER SET utf8 ;
...
CREATE TABLE `university_app`.`materia` (
...
CREATE TABLE `university_app`.`usuario` (
  `id` SMALLINT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `university_app`.`usuario_tipo` (
  `id` SMALLINT(11) NOT NULL AUTO_INCREMENT,
  `id_usuario_tipo` SMALLINT(11) NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_usuario_tipo`
  FOREIGN KEY (`id_usuario_tipo`)
  REFERENCES `university_app`.`usuario` (`id`)
  ON DELETE NO ACTION
  ON UPDATE NO ACTION);
...
CREATE TABLE `university_app`.`usuario_administrador` (
...
CREATE TABLE `university_app`.`usuario_alumno` (
  `id_usuario` SMALLINT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `university_app`.`usuario_profesor` (
  `id_usuario` SMALLINT(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id_usuario`),
